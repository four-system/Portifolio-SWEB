...
<div class="shop-layout">
    <section class="catalog">
        ...
        if (!$produtos) {
            ...
            foreach ($produtos as $p) {
                ...
                $maximo = max($estoque, 1);

                echo "<article 
                        class=\"card product-card\" 
                        data-id=\"$id\" 
                        data-name=\"$nomeAttr\" 
                        data-price=\"$precoValor\" 
                        data-stock=\"$estoque\">";
                ...
                echo "<p class=\"item-subtotal\">
                        Subtotal deste remédio: 
                        <strong>R$ $preco</strong>
                      </p>";
    ...
    <aside class="order-summary" aria-label="Resumo do pedido">
        ...
        <button id="clearCart" class="clear-cart" type="button">
            Limpar pedido
        </button>
